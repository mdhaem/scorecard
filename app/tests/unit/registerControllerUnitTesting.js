...
describe('Testing RegisterController', function() {
        ...
        describe('register', function() {
            ...
            it('Should get a hash value for successful registration', function(){
                ...
                scope.registerData.vemail = "mdhaem@gmail.com";
                scope.registerData.vpwd = "doscar";

                httpBackend.expectGET('http://iscorecards.com/service/CardGame.php?method=saveUser&email='+scope.registerData.email+'&pwd='+scope.registerData.pwd)
