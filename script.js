$( document ).ready(function(){
    ...
    $.ajax({
        type: "GET",
        url: "http://iscorecards.com/service/CardGame.php?method=getCardGames",
        dataType: "json",
    ...
    $( "#selectplayergroup" ).change(function() {
		...
		var idCardGame = $( "#cardgame" ).attr('value');
		var idGroupName = $( "#team" ).attr('value');

		///POPULATE SCORECARD WITH PLAYERS
		populatePlayers2(callback,idCardGame,idGroupName);
		function callback(result){
			scoreCard(result, 6, true, true, false);
		}
...
function populatePlayers(){
    $.ajax({
        type: "GET",
        url: "http://iscorecards.com/service/CardGame.php?method=getPlayers",
        dataType: "json",
        success: function(resp){
            var html = '';
            var len = resp.length;
...
function populatePlayers2(callback, idCardGame, idGroupName ){
	$.ajax({
		type: "GET",
		url: "http://iscorecards.com/service/CardGame.php?method=getPlayers&idCardGame="+idCardGame+"&idGroupName="+idGroupName,
		dataType: "json",
		success: callback,
		error: function(xhr, status, error) {
			//var err = eval("(" + xhr.responseText + ")");
...
function getHistory(){
    ...
    $.ajax({
        type: "GET",
        url: "http://iscorecards.com/service/CardGame.php?method=getHistory",
        dataType: "json",
        success: function(resp){
            var html = '';
            var len = resp.length;
...
function saveScore(idplayer, score, winner){
	...
	var URL = "http://iscorecards.com/service/CardGame.php?method=saveScore&idCardGame=" +
		$("#cardgame").attr('value') +
		"&idplayer=" +
		idplayer +
		"&score=" + 
	...
	function populatePlayerNames(groupName){
	    $.ajax({
	        type: "GET",
	        url: "http://iscorecards.com/service/CardGame.php?method=populateScoreCardNames&groupname="+groupName,
	        dataType: "json",
	        success: function(resp){
	            var html = '';
	            var len = resp.length;
	...
	function getNextGroup(){
        ...
        $.ajax({
            type: "GET",
            url: "http://iscorecards.com/service/CardGame.php?method=getNextPlayerGroup",
            dataType: "json",
			async: false,
            success: function(resp){
                html = '';
	...
	function getMaxGroup(){
        ...
        $.ajax({
            type: "GET",
            url: "http://iscorecards.com/service/CardGame.php?method=getMaxPlayerGroup",
            dataType: "json",
			async: false,
            success: function(resp){
                html = '';
	...
	function saveNewPlayerGroup(idPlayer, idCardGame, playerGroup){
		...
		var URL = "http://iscorecards.com/service/CardGame.php?method=saveNewPlayerGroup&idPlayer=" +
			idPlayer +
			"&idCardGame=" +
			idCardGame +
			"&playergroup=" + 
    ...
    function getGroupNames() {
        $.ajax({
            type: "GET",
            url: "http://iscorecards.com/service/CardGame.php?method=getgroupnames",
            dataType: "json",
            success: function(resp){
                // we have the response
